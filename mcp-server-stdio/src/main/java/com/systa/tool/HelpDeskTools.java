...
public class HelpDeskTools {
    ...
    String createTicket(@ToolParam(description = "Details to create a Support ticket")
        ...
        LOGGER.info("Ticket created successfully. Ticket ID: {}, Username: {}", savedTicket.id(), savedTicket.username());
        return "Ticket #" + savedTicket.id() + " created successfully for user " + savedTicket.username();
    }
